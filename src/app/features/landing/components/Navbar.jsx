...
const Navbar = () => {
  return (
    ...
    <div className='relative'>
        ...
        <div className='flex w-full flex-row justify-between fixed items-center 
        border-t-[1px] border-b-[1px] border-white/20 backdrop-blur-sm p-4'>


            <Image src="/lab-82-icon-white.svg" width={62} height={62} alt='Lab-82 Icon'/>
                <div className='z-10 flex flex-row gap-20 font-orbitron text-[14px] font-semibold uppercase'>
                    <p>About</p>
                    <p>Contact</p>
                    <p>Skills</p>
                    <div>
            ...
            <div className='font-orbitron font-semibold'>DEV : V01</div>
